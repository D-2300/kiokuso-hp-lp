...
export default function TContactForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      window.dataLayer.push({ event: "form_submit_tenant" });
      setSubmitted(true);
    } catch {
      setSubmitting(false);
    }
    ...
    >
      ...
      <div style={{ maxWidth: "480px", margin: "0 auto" }}>
        ...
        {submitted ? (
          ...
          >
            <input type="hidden" name="form-name" value="tenant-contact" />
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
              ...
              <textarea
                ...
                name="message"
                rows={4}
                placeholder="希望エリア、業態、予算感など、何でもお気軽にどうぞ"
                className="t-form-input"
                style={{
                  ...inputStyle,
                  resize: "vertical",
            ...
            <p style={{ margin: 0, fontSize: "11px", color: C.warmGray, textAlign: "center", lineHeight: 1.7 }}>
              物件情報の提供は無料です。お気軽にお問い合わせください。<br />
              ※不動産仲介は行いません。
            </p>
          </form>
        )}
