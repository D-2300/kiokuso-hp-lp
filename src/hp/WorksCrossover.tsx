      ...
      <div style={{ paddingTop: 0, backgroundColor: "#F8F5F0" }}>
        ...
        <div className="max-w-[860px] mx-auto px-6">
          ...
          <div className="space-y-6">
            ...
            <P>見つかった物件は、若林区の新築ビル2階。築3年、誰も入居しないまま残っていた事務所。ベニヤ張りの壁、同じくベニヤ張りの床、事務所用の蛍光灯。ここがバスケカフェになるイメージは、正直持ちにくかった。</P>
          ...
          <p className="text-sm text-[#888] mb-4">
            新築事務所。ベニヤ張りの壁と床、事務所用の蛍光灯。3年間空室のまま残っていた。
          </p>
          ...
          <div className="space-y-6">
            ...
            <P>
              ...
              ベニヤ張りの壁と天井を黒に塗り替えただけで、事務所感は完全に消える。新築物件は下地が綾麗なので塗装の仕上がりが良く、実はスケルトンよりも効率が良い。
            </P>
            <P>
